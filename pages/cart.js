  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center pb-10">
        <Head>
          <title>Hammerklavier Ecommerce  - Cart</title>
          <meta name="description" content={`Hammerklavier Ecommerce  - Shopping cart`} />
          <meta property="og:title" content="Hammerklavier Ecommerce  - Cart" key="title" />
        </Head>
        <div className="
