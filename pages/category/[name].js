...
const Category = (props) => {
  ...
  return (
    <>
      <CartLink />
      <Head>
        <title>Hammerklavier Ecommerce  - {title}</title>
        <meta name="description" content={`Hammerklavier Ecommerce  - ${title}`} />
        <meta property="og:title" content={`Hammerklavier Ecommerce  - ${title}`} key="title" />
      </Head>
