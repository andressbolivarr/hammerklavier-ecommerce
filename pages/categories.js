  ...
  return (
    <>
      <div className="w-full">
        <CartLink />
        <Head>
          <title>Hammerklavier Ecommerce  - All Categories</title>
          <meta name="description" content={`Hammerklavier Ecommerce  - All categories`} />
          <meta property="og:title" content="Hammerklavier Ecommerce  - All Categories" key="title" />
        </Head>
        <div className="
          pt-4 sm:pt-10 pb-8
        ">
