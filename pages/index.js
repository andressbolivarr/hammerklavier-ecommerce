  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>Hammerklavier ECommerce</title>
          <meta name="description" content="Hammerklavier Ecommerce  Next provides a way to quickly get up and running with a fully configurable ECommerce site using Next.js." />
          <meta property="og:title" content="Hammerklavier ECommerce" key="title" />
        </Head>
        ...
        flex lg:flex-row flex-col">
          <div className="pt-4 pl-2 sm:pt-12 sm:pl-12 flex flex-col">
            ...
            <Footer
              designer="L. Bösendorfer Klavierfabrik GmbH"
            />
          </div>
      ...
      <div className="pt-10 pb-6 flex flex-col items-center">
        ...
        <p className="text-gray-600 text-sm">Find the perfect piano for your favorite room in the house.</p>
      </div>
